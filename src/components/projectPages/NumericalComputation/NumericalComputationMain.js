        ...
        return(
            <div className = "projects-grid">
                    ...
                    <Row>
                                ...
                                <CardTitle style={{color: 'black', margin: 'auto', textAlign: 'center', justifyContent: 'center', background: 'url(https://rmanwiki.pixar.com/download/attachments/45744152/curves_b-spline_with_multiplicity.jpg?api=v2) center', backgroundRepeat: 'no-repeat', width: '324px', height: '100%'}}></CardTitle> 
                                        ...
                                        <p style={{color:  '#556270', backgroundColor: '#ee8d8d', border: 'solid #0cf2ad 2px', width: '100%', opacity: '1.0 !important', margin: 'auto', textAlign: 'center', justifyContent: 'center', fontSize: '1.32em', fontFamily: "'Fredoka One'", position: 'relative'}}>B SPLINE</p>
                                    </Card>
                                    <div className='separator' />
                                </Col>
